...
class _SwiperState extends State<Swiper> {
  ...
  Widget build(BuildContext context) {
    return Stack(
      alignment: widget.scrollDirection == Axis.horizontal ? Alignment.bottomCenter : Alignment.centerRight,
      children: [
        _buildPageView(),
        _buildIndicator(),
      ],
  ...
  Widget _buildPageView() {
    ...
    return Container(
      ...
      child: PageView.builder(
        ...
        physics: length > 1 ? ScrollPhysics() : NeverScrollableScrollPhysics(),
        onPageChanged: (index) {
          setState(() {
            _currentIndex = index;
          });
            ...
            child: Container(
              ...
              child: ClipRRect(
                ...
                child: Container(
                  ...
                  child: Image(
                    image: _getImage(widget.images[index % length]),
                    fit: widget.imgFit,
                  ),
                ),
              ),
                        ...
                        child: Padding(
                          ...
                          child: ClipOval(
                            child: Container(
                              width: _width,
                              height: _height,
                              color: e == widget.images[_currentIndex % length] ? widget.activeColor : widget.defaultColor,
                            ),
                          ),
                        ));
                  },
