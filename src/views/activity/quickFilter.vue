    ...
    <app-template @init="init">
        <div class="Page-subject celarfix" :style="[{'padding-top':isApp ? '0' :'0.92rem'}]">
            <div class="goods-list">
                <van-list v-model="loading" :finished="finished" :finished-text="'我是有底线的'" :offset="50" :immediate-check="false" @load="onLoad">
...
export default {
    ...
    methods: {
        ...
        onLoad() {
            ...
            Api.fetchQuickFilterList(params).then(({ data: { data }}) => {
